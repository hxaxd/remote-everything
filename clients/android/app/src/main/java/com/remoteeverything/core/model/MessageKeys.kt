...
object MessageKeys {
    ...
    const val DIAG_ATTEMPTS = "diag.attempts"
    const val DIAG_CAUSE = "diag.cause"
    const val DIAG_CAUSE_BAD_ANSWER = "diag.cause_bad_answer"
    const val DIAG_CAUSE_NO_NETWORK = "diag.cause_no_network"
    const val DIAG_CAUSE_REFUSED = "diag.cause_refused"
    const val DIAG_CAUSE_UNREACHABLE = "diag.cause_unreachable"
    const val DIAG_CAUSE_UNKNOWN = "diag.cause_unknown"
    const val DIAG_CLIENT = "diag.client"
    const val DIAG_CONNECTION = "diag.connection"
    const val DIAG_DEVICE_NAME = "diag.device_name"
    const val DIAG_FAILURES = "diag.failures"
    const val DIAG_LAST_ANSWER = "diag.last_answer"
    const val DIAG_MACHINES = "diag.machines"
    const val DIAG_NETWORK = "diag.network"
    const val DIAG_SINCE = "diag.since"
    const val DIAG_STATE = "diag.state"
    const val DIAG_SYSTEM = "diag.system"
    const val DIAG_TITLE = "diag.title"
    ...
    const val SETTINGS_COPY_ERROR = "settings.copy_error"
