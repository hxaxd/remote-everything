...
class ProfileCodecTest {
    ...
    fun multipleProfilesRoundTripWithoutLosingIdentity() {
        val values = listOf(
            AppConfig.create(id, "LAN", "lan", "https://192.0.2.10:4443", fingerprint),
    ...
    fun unknownOrMissingFieldsAreRejected() {
        val encoded = ProfileCodec.encode(AppConfig.create(id, "LAN", "lan", "https://192.0.2.10:4443", fingerprint))
